      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-152px)] w-full max-w-[1380px] items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto w-full max-w-[950px] text-center">
          ...
          <p className="mx-auto mt-6 max-w-[650px] text-sm font-medium leading-7 text-white/70 sm:text-base sm:leading-8">
            Prove your trading process, meet clear objectives, and earn the opportunity
            to trade with BlackProp capital.
          </p>
          ...
          <div className="mt-8 flex items-center justify-center">
            <a
              href="#challenges"
              className="
                group relative inline-flex min-w-[190px]
                items-center justify-center
                overflow-hidden rounded-xl
                bg-[linear-gradient(135deg,#F5DD82_0%,#D4AF37_50%,#9B7115_100%)]
                px-7 py-4
                text-xs font-black
                uppercase tracking-[0.04em]
                text-[#080806]
                shadow-[0_15px_45px_rgba(212,175,55,.16)]
                transition-all duration-300
                hover:-translate-y-0.5
                hover:shadow-[0_18px_55px_rgba(212,175,55,.25)]
                sm:text-sm
              "
            >
              GET FUNDED
