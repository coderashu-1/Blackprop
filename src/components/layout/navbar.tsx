...
const tradingLinks = [
  ...
  {
    label: "Rewards",
    description: "Explore payouts, scaling and trader benefits.",
    href: "#rewards",
  },
];
...
function MarketIcon({ market }: { market: Market }) {
  ...
  return (
    ...
    >
      <path
        d="M12.6 6.2c-.35-1.05-1.32-1.7-2.8-1.7H7.2v11h3c1.8 0 3-.9 3-2.45 0-1.25-.75-2.05-2.05-2.3 1.05-.3 1.7-1.05 1.7-2.1 0-.95-.45-1.75-1.3-2.15"
        stroke="currentColor"
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="M8.5 3v2M11 3v2M8.5 15.5v1.5M11 15.5v1.5"
        stroke="currentColor"
        strokeWidth="1.35"
        strokeLinecap="round"
      />
...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
              ...
              {markets.map((market) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold transition-all duration-300 sm:px-3 ${
                      active
                        ? "bg-[linear-gradient(135deg,#E8C866,#AF8720)] text-[#080808] shadow-[0_5px_18px_rgba(212,175,55,0.16)]"
                        : "text-white/42 hover:bg-white/[0.04] hover:text-white/85"
                    }`}
                  >
                    ...
                    {active && (
                      <span className="absolute inset-x-2 -bottom-[5px] h-px bg-[#F4D77B]/60 blur-[1px]" />
                    )}
                  </button>
                );
              })}
      ...
      <div className="relative overflow-hidden border-b border-[#D4AF37]/[0.12] bg-[#090806]/95">
        ...
        <div className="relative mx-auto flex min-h-9 max-w-[1440px] items-center justify-center gap-2.5 px-4 py-1.5 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[#D4AF37]/20 bg-[#D4AF37]/[0.07] px-2.5 py-1 text-[10px] font-bold tracking-[0.1em] text-[#E8C866] transition duration-300 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/[0.12]"
          >
      ...
      <div className="relative border-b border-white/[0.06] bg-[#050505]/88 shadow-[0_16px_55px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
        ...
        >
          ...
          <div className="absolute left-1/2 hidden -translate-x-1/2 items-center lg:flex">
            ...
            <div className="relative">
              ...
              >
                ...
                <Chevron
                  open={openDropdown === "trading"}
                />
              </button>

              {openDropdown === "trading" && (
                <div className="absolute left-1/2 top-[calc(100%+14px)] w-[340px] -translate-x-1/2 overflow-hidden rounded-2xl border border-white/[0.09] bg-[#0A0A0B]/98 p-2 shadow-[0_30px_90px_rgba(0,0,0,0.7)] backdrop-blur-2xl">
                  ...
                  {tradingLinks.map((item) => (
                    <a
                      ...
                      className="group flex items-center justify-between rounded-xl px-3 py-3 transition duration-300 hover:bg-white/[0.04]"
                    >
                      <div>
                        ...
                        <div className="mt-1 text-[11px] leading-4 text-white/32">
                          {item.description}
                        </div>
                      </div>

                      <div className="ml-4 text-white/25 transition group-hover:text-[#D4AF37]">
                        <ArrowUpRight />
                      </div>
                    </a>
                  ))}
            ...
            <a
              href="#affiliate"
              className="rounded-xl px-3.5 py-2.5 text-sm font-medium text-white/58 transition hover:bg-white/[0.035] hover:text-white"
            >
              Affiliate
            </a>
            ...
            <a
              href="#competition"
              className="relative rounded-xl px-3.5 py-2.5 text-sm font-medium text-white/58 transition hover:bg-white/[0.035] hover:text-white"
            >
              Competition
            ...
            <div className="relative">
              ...
              {openDropdown === "company" && (
                <div className="absolute left-1/2 top-[calc(100%+14px)] w-[320px] -translate-x-1/2 overflow-hidden rounded-2xl border border-white/[0.09] bg-[#0A0A0B]/98 p-2 shadow-[0_30px_90px_rgba(0,0,0,0.7)] backdrop-blur-2xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              ...
              <a
                href="#login"
                className="rounded-xl border border-white/[0.09] bg-white/[0.025] px-4 py-2.5 text-sm font-medium text-white/70 transition duration-300 hover:border-white/[0.16] hover:bg-white/[0.055] hover:text-white"
              >
                Log In
              </a>
              ...
              <a
                href="#challenges"
                className="group relative overflow-hidden rounded-xl bg-[linear-gradient(135deg,#F2D675_0%,#D4AF37_45%,#A57B18_100%)] px-5 py-2.5 text-sm font-bold text-[#080808] shadow-[0_8px_28px_rgba(212,175,55,0.17)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_35px_rgba(212,175,55,0.25)]"
              >
          ...
          {/* MOBILE PANEL */}
          {mobileOpen && (
            <div className="absolute inset-x-4 top-[calc(100%+10px)] max-h-[calc(100vh-180px)] overflow-y-auto rounded-3xl border border-white/[0.09] bg-[#080809]/98 p-4 shadow-[0_35px_100px_rgba(0,0,0,0.75)] backdrop-blur-2xl sm:inset-x-6 lg:hidden">
